...
\psset{colsep=3cm,rowsep=1cm, arrows=->, arrowsize=6pt, arrowinset=0, labelsep=3pt}
\begin{psmatrix}
...
\ncline[linewidth=1.5pt, linecolor=blue]{3,1}{1,2}\mput*{1}
