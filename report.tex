...
\hfill
\subfigure[4th $3\times 3$ sub-grid after running the all-different algorithm]{\includegraphics[width=8cm]{images/proof_of_concept/4.png}}
\vspace*{2cm}
\hfill
%\caption{Title for both}
%\end{figure}
...
\noindent I would like to thank my supervisor, \normalfont{Dr. Patrick Prosser}, and Ciaran McCreesh, for all their guidance and feedback provided throughout this project.
